...
function DriveTab(){
  ...
  // ── زر الرفع ──
  function handleSave(){
    setStatus("busy");setMsg("جارٍ الرفع...");
  ...
  function handleLoad(){
    ...
    setStatus("busy");setMsg("جارٍ الاسترجاع...");
    withToken(async function(tk){
      try{
        var fid=fileId;
        if(!fid){
  ...
  return React.createElement("div",{style:{display:"flex",flexDirection:"column",gap:12}},
    ...
    React.createElement("div",{style:{background:"linear-gradient(135deg,#0c1a2e,#0d2448)",border:"1px solid #1e3a5f",borderRadius:12,padding:16,textAlign:"center"}},
      ...
      React.createElement("div",{style:{color:"#60a5fa",fontWeight:800,fontSize:15}},"نسخ Google Drive الاحتياطي"),
